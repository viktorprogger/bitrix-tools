...
namespace adapt\tools\common\arrayHelper;
...
class ArrayHelper
{
     ...
     */
    public static function toArray($object, array $properties = [], $recursive = true)
    {
        if (is_array($object)) {
            if ($recursive) {
    ...
    public static function filter($array, $filters)
    {
        ...
        foreach ($forbiddenVars as $keys) {
            list($globalKey, $localKey) = $keys;
            if (array_key_exists($globalKey, $result)) {
